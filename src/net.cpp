...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Roguecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"roguecointools.com", "173.29.117.46"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"roguecointools.com", "testnet-seed.roguecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Roguecoin is probably already running."), addrBind.ToString().c_str());
        else
